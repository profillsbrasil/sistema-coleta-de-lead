			...
			<Tooltip>
				...
				>
					<span className="relative inline-flex items-center justify-center">
						...
						{badgeText !== null && (
							<span className="absolute -top-1 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-warning px-0.5 font-semibold text-warning-foreground text-xs tabular-nums">
								{badgeText}
							</span>
						)}
					</span>
