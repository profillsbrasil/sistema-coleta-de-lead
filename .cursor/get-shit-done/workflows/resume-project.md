...
<required_reading>
@/home/othavio/Work/sistema-coleta-de-lead/.cursor/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/othavio/Work/sistema-coleta-de-lead/.cursor/get-shit-done/bin/gsd-tools.cjs" init resume)
