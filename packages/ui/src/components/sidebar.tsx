...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@dashboard-leads-profills/ui/components/sheet";
...
function SidebarGroupContent({
	...
	return (
		<div
			className={cn("w-full text-sms", className)}
